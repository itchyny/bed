...
func defaultKeyManagers() map[Mode]*KeyManager {
	...
	km.Register(EventWincmdFocusDown, "c-w", "down")
	km.Register(EventWincmdFocusDown, "c-w", "c-j")
	km.Register(EventWincmdFocusDown, "c-w", "j")
	km.Register(EventWincmdFocusUp, "c-w", "up")
	km.Register(EventWincmdFocusUp, "c-w", "c-k")
	km.Register(EventWincmdFocusUp, "c-w", "k")
	km.Register(EventWincmdFocusLeft, "c-w", "left")
	km.Register(EventWincmdFocusLeft, "c-w", "c-h")
	km.Register(EventWincmdFocusLeft, "c-w", "backspace")
	km.Register(EventWincmdFocusLeft, "c-w", "h")
	km.Register(EventWincmdFocusRight, "c-w", "right")
	km.Register(EventWincmdFocusRight, "c-w", "c-l")
	km.Register(EventWincmdFocusRight, "c-w", "l")
	km.Register(EventWincmdFocusTopLeft, "c-w", "t")
	km.Register(EventWincmdFocusTopLeft, "c-w", "c-t")
	km.Register(EventWincmdFocusBottomRight, "c-w", "b")
	km.Register(EventWincmdFocusBottomRight, "c-w", "c-b")
	km.Register(EventWincmdMoveTop, "c-w", "K")
	km.Register(EventWincmdMoveBottom, "c-w", "J")
